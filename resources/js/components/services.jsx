...
const ServicesSection = () => {
    const consultations = [
        { id: 1, img: "pathways.png", name: "Pathway Consultancy", description: "We assist you in identifying the right course that matches your skills and abilities, helping you find the perfect educational institution to pursue your academic goals.", buttonText: "Learn More", link: "#" },
        { id: 2, img: "visa.png", name: "Visa Lodging", description: "We guide and process your visa requirements, ensuring that all necessary documents are completed accurately and submitted on time. Our goal is to simplify the visa application process and maximize your chances of success.", buttonText: "Learn More", link: "#" },
        ...
        <section className="py-12 bg-gray-100 font-urbanist relative overflow-hidden">
            <div className="text-center mb-10">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">
                    Services <span className="text-green-700">ePathways</span> Offers
                </h2>
            </div>
            ...
            <div className="flex justify-center items-center gap-4">
                ...
                <div className="relative w-full max-w-6xl overflow-hidden">
                    <AnimatePresence mode="wait" custom={direction}>
                        <motion.div
                            key={currentIndex}
                            className={`grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-${itemsPerPage}`}
                            custom={direction}
